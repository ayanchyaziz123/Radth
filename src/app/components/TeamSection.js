...
const team = [
  { name: 'Azizur Rahman (Ayan)', role: 'Co-Founder & Lead AI Engineer', initials: 'AR', photo: '/images/cover6.jpeg', bio: 'Designs and ships the ML pipelines, from model training to production inference.', gradient: 'linear-gradient(135deg,#0ea5e9,#0284c7)' },
