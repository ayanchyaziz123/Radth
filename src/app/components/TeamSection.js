...
const team = [
  { name: 'Founder Name', role: 'Founder & CEO', initials: 'FN', bio: 'Sets the product vision and leads client strategy across AI and game projects.', gradient: 'linear-gradient(135deg,#0ea5e9,#0284c7)' },
