...
const team = [
  { name: 'Azizur Rahman (Ayan)', role: 'Co-Founder & Chief Technology Officer (CTO)', initials: 'AR', photo: '/images/cover6.jpeg', bio: 'Leads mobile, web, and ML product development from idea to design to production.', gradient: 'linear-gradient(135deg,#0ea5e9,#0284c7)' },
